...
public:
   ...
   */
  VAT** intersect(PAT* const& p1, PAT* const& p2, PAT_SUP** cand_sups, PAT** cand_pats, 
		  const bool& isfwd, const pair<int, int>& ids, const int& minsup) {
    ...
    VAT** ret = VAT::intersection(v1, v2, cand_sups, cand_pats, isfwd, ids, minsup);
